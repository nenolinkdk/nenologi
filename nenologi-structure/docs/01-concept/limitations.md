...
Natural language cannot always be reduced safely to a single formal representation.

Nenologi must therefore allow results such as:

- Certain
- Probable interpretation
- Ambiguous
- Cannot be safely formalized
