...
| entailment_007 | entailment | OK | AV | NA | NA | NO | INFERENCE_NOT_IMPLEMENTED | METAPHOR_NON_LITERAL_FORMALIZATION |
...
| entailment_007 | Complete: safe entity and non-literal marker retained; no literal proposition emitted | Non-literal interpretation policy | No | HIGH |

Exact Explicit Inference handles entailment_001, Universal Instantiation handles entailment_002, Lexical Opposition handles entailment_005, and controlled residence/fluency representation makes entailment_004 exactly unsupported. `entailment_003`, `_006`, and `_007` are representation-ready but still lack prediction, alternative-reading evaluation, and non-literal policy.
