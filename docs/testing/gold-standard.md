...
The machine-readable audit supersedes hand-maintained supported-ID counts. The Phase 1 exit baseline contained 19 exact cases; Simple Past Transitive v0.1 raised the result to 21, Simple Passive Transitive v0.2 to 22, Contraction Normalization v0.3 to 23, and Controlled Spatial Copular Relations v0.1 to 24 by activating `entity_relation_003`. Gold expectations were unchanged. Full reproducible totals and per-case blockers are documented in the [Phase 1 completion audit](../architecture/phase-1-completion-audit.md).
