...
The machine-readable audit supersedes hand-maintained supported-ID counts. Successive milestones raised the result from the 19-case Phase 1 exit baseline to 29 exact cases; [Controlled Residence/Fluency Non-entailment v0.1](../architecture/residence-fluency-non-entailment-v0.1.md) makes `entailment_004` the 30th by representing both propositions and preserving the conservative open-world result. No inference gold expectation was changed.
