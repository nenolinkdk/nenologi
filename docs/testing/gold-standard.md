...
The machine-readable audit supersedes hand-maintained supported-ID counts. Successive controlled parser milestones raised the result from the 19-case Phase 1 exit baseline to 25. Condition/Omission Taxonomy Resolution v0.1 then raised coverage to 26 exact, and [Exact Explicit Inference v0.1](../architecture/exact-explicit-inference-v0.1.md) makes `entailment_001` the 27th exact case. No inference gold expectation was changed.
