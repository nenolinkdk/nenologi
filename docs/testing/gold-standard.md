...
The machine-readable audit supersedes hand-maintained supported-ID counts. Successive milestones raised the result from the 19-case Phase 1 exit baseline to 28 exact cases; [Universal Instantiation v0.1](../architecture/universal-instantiation-v0.1.md) makes `entailment_002` the 29th by applying its previously prepared normalized rule and membership structures. No inference gold expectation was changed.
