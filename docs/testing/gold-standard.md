...
The machine-readable audit supersedes hand-maintained supported-ID counts. Successive controlled parser milestones raised the result from the 19-case Phase 1 exit baseline to 25. Condition/Omission Taxonomy Resolution v0.1 raised it to 26, Exact Explicit Inference v0.1 to 27, and [Lexical Opposition Contradiction v0.1](../architecture/lexical-opposition-contradiction-v0.1.md) makes `entailment_005` the 28th exact case. No inference gold expectation was changed.
